...
5. Run-OutRunVRTest.ps1 already waits for the game to exit and invokes Collect-OutRunVRLogs.ps1 automatically. The collector includes the HUD CSV and writes the exact local OR2006C2C.EXE SHA-256 into EXE_IDENTITY.txt.
