...
namespace OutRunVRStereo
{
    namespace
    {
            ...
            HWND destWindowOverride, const RGNDATA* dirtyRegion)
        {
            ...
            // R23 is the final effective Present observer/recovery owner in the
            // layered hook chain. First private-resource initialization belongs
            // to the runtime-known-good R7 boundary immediately after the raw
            // game Present succeeds; R23 must not become a second/late owner.
