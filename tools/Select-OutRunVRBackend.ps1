...
$defaultVariant = switch ($Backend) {
    "2d"        { "CONTROL_2D" }
    "d3d9"      { "A_CONTROL" }
    "dx11"      { "R58_07_ALL_PROJECTED_HEAD" }
