...
# Round-11 reference model remains useful as a regression check for the original
# pseudo-SAT shape. Round-15 has its own exact final-value/numeric verifier.
