...
req(build, 'FloralVillageStage = 27', 'Floral Village comfort policy is pinned to the proven forward stage ID')
req(build, 'FloralVillageBrickRoadSectionFirst = 510', 'Floral Village rough primary-road section start is evidence-pinned')
req(build, 'FloralVillageBrickRoadSectionLast = 533', 'Floral Village rough primary-road section end is evidence-pinned')
req(build, 'FloralVillageRoughPavingMask = 0x00100000u', 'Floral Village rough primary-road material uses the proven 0x100000 surface mask')
req(build, 'FloralVillageRoughPavingScale = 0.60f', 'Floral Village rough primary-road Road Detail comfort scale is stable')
req(build, 'else if (mask != FloralVillageAsphaltMask)', 'non-primary curb/off-road masks cancel Floral Village road attenuation')
req(build, 'originalRoadTexture * FloralVillageRoughPavingScale', 'Floral Village comfort policy scales Road Detail instead of force families')
req(build, '!floralVillageRoughPaving &&', 'Floral Village sustained rough primary road bypasses generic curb boost')
req(build, 'if (!floralVillageRoughPaving)', 'Floral Village road attenuation does not unload SAT/damper')
