...
req(build, 'Range<int>{ 0, 7 }', 'FFB feel migration revision includes R3 direction/regrip validation')
...
req(build, 'Settings::WheelFFBFeelRevision = 7;', 'current universal presets stamp feel revision 7')
