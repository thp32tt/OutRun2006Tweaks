...
req(ffb, 'surfaceRough={} ps2Surface={} ps2RoadRaw={} ps2Drive={}', '10Hz telemetry exposes PS2 retail road-chain intermediates')
req(ffb, 'roughness, ps2SurfaceEnvelope, ps2RoadRaw, ps2DriveFactor', 'PS2 telemetry arguments match retail road-chain fields')
